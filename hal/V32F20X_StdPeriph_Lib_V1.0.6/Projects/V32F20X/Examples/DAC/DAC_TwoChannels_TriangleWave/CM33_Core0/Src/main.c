...
int main(void)
{
  ...
  DAC_InitStructure.DAC_WaveGeneration               = DAC_WAVE_GENERATION_TRIANGLE;
  DAC_InitStructure.DAC_LFSRUnmask_TriangleAmplitude = DAC_TRIANGLE_AMPLITUDE_4095; 
  ...
  printf("DAC two channels triangle wave test\r\n");
  while (1)
  {
  }
}
