...
int main(void)
{
  ...
  if (PMU_DSLPWKU_U32K0 == Wakeup_Src)
  {
    printf("U32K0 Deep Sleep Wakeup Wakeup_Src =0x%x.\r\n", Wakeup_Src);
  ...
  PMU_WKUSRCConfig(SLEEP_CORE_CM33, PMU_WKUSRC_U32K0, ENABLE);
  PMU_WKUSRCConfig(SLEEP_CORE_CM0, PMU_WKUSRC_U32K0, ENABLE);
...
void GPIO_Configuration(void)
{
  ...
  SYSCFGLP_PeriphReset(SYSCFGLP_PeriphReset_RETRAM);
  ...
  /* Configure PD14 as alternate input */
