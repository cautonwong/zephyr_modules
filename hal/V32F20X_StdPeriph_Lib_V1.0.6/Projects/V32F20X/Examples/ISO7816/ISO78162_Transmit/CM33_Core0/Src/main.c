...
int main(void)
{
  ...
  SYSCFG1_Periph1ClockCmd(SYSCFG1_Periph1Clock_ISO78162, ENABLE);
  SYSCFG1_PeriphReset(SYSCFG1_Periph1Clock_ISO78162);
  
  GPIO_PinAFConfig(GPIOA, GPIO_PinSource15, GPIO_AF10_ISO78162_DAT);
  GPIO_PinAFConfig(GPIOI, GPIO_PinSource3, GPIO_AF10_ISO78162_CLK);
...
/**
  * @brief  CM33/CM0 AHB and APB Clock Configuration
  *         The Bus Clock is configured as follows :
  *            CM33 HCLK    = RCH 48 MHz
  *            CM33 PCLK    = RCH
  *            CM0 HCLK     = RCH
  *            CM0 HCLK     = RCH
  * @param  None
...
void SystemClock_Config(void)
{
  ...
  /* Select RCH as CM33/CM0 AHB and APB clock */
