...
{
  if (SET == ADC_GetINTStatus(ADC0, ADC_INT_EC))
  {
    ADC_ClearINTPendingBit(ADC0, ADC_INT_EC);
  }

  if (SET == ADC_GetINTStatus(ADC0, ADC_INT_JEC))
  {
...
{
  if (SET == ADC_GetINTStatus(ADC1, ADC_INT_EC))
  {
    ADC_ClearINTPendingBit(ADC1, ADC_INT_EC);
  }
  
  if (SET == ADC_GetINTStatus(ADC1, ADC_INT_JEC))
  {
