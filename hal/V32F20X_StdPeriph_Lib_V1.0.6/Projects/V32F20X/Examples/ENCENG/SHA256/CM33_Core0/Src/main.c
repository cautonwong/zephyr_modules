...
const uint8_t Expcted[32] = {
  0x1b, 0x7f, 0x0d, 0x44, 0xb6, 0x96, 0x5e, 0x96, 0x37, 0xf5, 
  0xa9, 0xa1, 0xe2, 0xe4, 0x50, 0x6e, 0x0d, 0x3f, 0xd5, 0x25, 
  0xf1, 0xae, 0x8e, 0x4c, 0x5b, 0x44, 0x36, 0xdb, 0x6e, 0x68, 
  0x76, 0xe4
};
...
int main(void)
{
  ...
  ENCENG_SHA256((uint8_t *)Input, sizeof(Input), Output);
  
  if (memcmp(Expcted, Output, 32) == 0)
  {
    printf("SHA256 disgest is expected.\r\n");
  }
  else
  {
    printf("SHA256 disgest is not expected.\r\n");
  }
