...
const uint8_t Key[64] = {
  ...
  0xb4, 0x13, 0x38, 0xa2, 0xf2, 0x45, 0x2b, 0x61, 0xef, 0x05, 
  0x6b, 0x91, 0xc9, 0x08, 0xe2, 0xc3, 0xc6, 0x6c, 0x56, 0x5b, 
  0x1c, 0x43, 0xf1, 0x56, 0x4e, 0x52, 0xb9, 0x8a, 0x3e, 0x59, 
  0x18, 0xae, 0xde, 0x72
};

const uint8_t Expcted[32] = {
  0x54, 0x06, 0x6a, 0xa3, 0xaf, 0x6e, 0x52, 0x8c, 0xc9, 0x86, 
  0x45, 0x3b, 0xb3, 0x6c, 0xec, 0x67, 0xdf, 0xde, 0x22, 0x1d, 
  0xaf, 0xc3, 0x56, 0x82, 0xb9, 0x88, 0x98, 0x6e, 0x0b, 0xcc, 
  0x43, 0xfe
};
...
int main(void)
{
  ...
  ENCENG_HMAC_SHA256((uint8_t *)Input, sizeof(Input), 
                     (uint8_t *)Key, sizeof(Key),
                     Output);
  if (memcmp(Expcted, Output, 32) == 0)
  {
    printf("HMAC SHA256 disgest is expected.\r\n");
  }
  else
  {
    printf("HMAC SHA256 disgest is not expected.\r\n");
  }
