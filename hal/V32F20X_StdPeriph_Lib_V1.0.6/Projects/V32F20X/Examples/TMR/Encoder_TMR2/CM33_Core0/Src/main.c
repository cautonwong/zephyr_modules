...
int main(void)
{
  ...
  /* ETMR1 encoder mode configuration--------------------------
  ETMR1 TI1PF1 ,TI2FP2 as encoder input pin, ETMR1 counter
  ...
  TMR_EncoderInterfaceConfig(ETMR1,TMR_EncoderMode_TI12,TMR_ICPolarity_Rising,TMR_ICPolarity_Rising);
  ...
  while (1)
  {
    ...
    STD_Delay(100);
    printf("The Timer Cnt value: %d\r\n",TMR_GetCounter(ETMR1));
  }
}
