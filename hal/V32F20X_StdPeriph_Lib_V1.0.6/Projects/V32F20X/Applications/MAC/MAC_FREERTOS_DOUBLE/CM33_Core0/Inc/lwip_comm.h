...
/* IP address, netmask and MAC address for  MAC1 when both MACs are active */
#define   IP_ADDR1            "192.168.0.60"
#define   DEFAULT_GATEWAY1    "192.168.0.1"
#define   NET_MASK1           "255.255.255.0"
#define   MAC_ADDR1_0         (0x02)
#define   MAC_ADDR1_1         (0x00)
#define   MAC_ADDR1_2         (0x00)
#define   MAC_ADDR1_3         (0x28)
#define   MAC_ADDR1_4         (0x01)
#define   MAC_ADDR1_5         (0x66)
