...
extern __IO unsigned gAB[4096 / 32] __attribute__((section(".ARM.__at_0x200F0000")));
extern __IO unsigned gCD[64 * 256 / 32] __attribute__((section(".ARM.__at_0x200F0000")));
extern __IO unsigned gResult[(64 * 256 / 32) + 2] __attribute__((section(".ARM.__at_0x200F0000")));
...
#define STD_FEATURE_CASPER_RAM_BASE_ADDRESS (0x200F0000UL)
