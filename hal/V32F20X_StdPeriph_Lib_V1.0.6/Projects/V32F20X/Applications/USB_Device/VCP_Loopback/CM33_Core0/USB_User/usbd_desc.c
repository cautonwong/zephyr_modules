...
#define USBD_MANUFACTURER_STRING        "SC"
#define USBD_PRODUCT_HS_STRING          "SCM Virtual COM Port in HS mode"
#define USBD_PRODUCT_FS_STRING          "SCM Virtual COM Port in FS Mode"
...
static void Get_SerialNum(void)
{
  ...
  deviceserial0 = 0x11111111;
  deviceserial1 = 0x22222222;
  deviceserial2 = 0x33333333;
