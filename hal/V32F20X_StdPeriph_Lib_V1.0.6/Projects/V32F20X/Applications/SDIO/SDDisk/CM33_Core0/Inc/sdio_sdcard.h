...
#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x01)         //24M
...
uint8_t SD_Detect(SDIO_TypeDef *SDIOx);
SD_Error SD_PowerON(SDIO_TypeDef *SDIOx);
SD_Error SD_PowerOFF(SDIO_TypeDef *SDIOx);
...
SDTransferState SD_GetTransferState(SDIO_TypeDef *SDIOx);
SD_Error SD_StopTransfer(SDIO_TypeDef *SDIOx);
...
void NVIC_Configuration(SDIO_TypeDef *SDIOx); 
