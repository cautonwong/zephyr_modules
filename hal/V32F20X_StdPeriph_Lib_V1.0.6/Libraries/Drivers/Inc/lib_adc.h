...
typedef struct
{
    ...
    FunctionalState ADC_BtimerTrig;         /*!< Whether to use Btimer trigger.
                                               This parameter can be set to ENABLE or DISABLE */    
} ADC_InitType;
/**
  * @}
...
/** @defgroup ADC_external_trigger_sources_for_regular_channels_conversion 
  * @{
  */
#define ADC_EXT_TRIG_TIMER_SELECT                 ((uint32_t)0x00000010) 
#define ADC_EXT_TRIG_CONV_T1_CC1                  ((uint32_t)0x00000000)
#define ADC_EXT_TRIG_CONV_T1_CC2                  ((uint32_t)0x00020000)
#define ADC_EXT_TRIG_CONV_T1_CC3                  ((uint32_t)0x00040000)
#define ADC_EXT_TRIG_CONV_T3_CC2                  ((uint32_t)0x00060000)
#define ADC_EXT_TRIG_CONV_T4_TRGO                 ((uint32_t)0x00080000)
#define ADC_EXT_TRIG_CONV_T5_CC4                  ((uint32_t)0x000A0000)
#define ADC_EXT_TRIG_CONV_EXT_IT11_TIM2_TRGO      ((uint32_t)0x000C0000)
#define ADC_EXT_TRIG_CONV_BPWM0_TRGO               ((uint32_t)0x00010000)
#define ADC_EXT_TRIG_CONV_BPWM1_TRGO               ((uint32_t)0x00030000)
#define ADC_EXT_TRIG_CONV_BPWM2_TRGO               ((uint32_t)0x00050000)
#define ADC_EXT_TRIG_CONV_BPWM3_TRGO               ((uint32_t)0x00070000)
#define ADC_EXT_TRIG_CONV_NONE                    ((uint32_t)0x000E0000)
#define IS_ADC_EXT_TRIG(TRIG)                     (((TRIG) == ADC_EXT_TRIG_CONV_T1_CC1)              || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_T1_CC2)              || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_T1_CC3)              || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_T3_CC2)              || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_T4_TRGO)             || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_T5_CC4)              || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_EXT_IT11_TIM2_TRGO)  || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_BPWM0_TRGO)          || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_BPWM1_TRGO)          || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_BPWM2_TRGO)          || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_BPWM3_TRGO)          || \
                                                   ((TRIG) == ADC_EXT_TRIG_CONV_NONE))
/**
  * @}
  */
...
#define ADC_SampleTime_4_5                          ((uint8_t)0x00)
...
#define IS_ADC_SAMPLE_TIME(TIME)                    (((TIME) == ADC_SampleTime_4_5) || \
...
/** @defgroup ADC_external_trigger_sources_for_injected_channels_conversion 
  * @{
  */
#define ADC_EXT_INJEC_TRIG_TIMER_SELECT             ((uint32_t)0x00000020) 
#define ADC_EXT_TRIG_INJEC_T1_TRGO                  ((uint32_t)0x00000000)
#define ADC_EXT_TRIG_INJEC_T1_CC4                   ((uint32_t)0x00001000)
#define ADC_EXT_TRIG_INJEC_T3_TRGO                  ((uint32_t)0x00002000)
#define ADC_EXT_TRIG_INJEC_T3_CC1                   ((uint32_t)0x00003000)
#define ADC_EXT_TRIG_INJEC_T4_CC4                   ((uint32_t)0x00004000)
#define ADC_EXT_TRIG_INJEC_T5_TRGO                  ((uint32_t)0x00005000)
#define ADC_EXT_TRIG_INJEC_EXT_IT15_TIM2_CC4        ((uint32_t)0x00006000)
#define ADC_EXT_TRIG_INJEC_BPWM0_TRGO               ((uint32_t)0x00010000)
#define ADC_EXT_TRIG_INJEC_BPWM1_TRGO               ((uint32_t)0x00011000)
#define ADC_EXT_TRIG_INJEC_BPWM2_TRGO               ((uint32_t)0x00012000)
#define ADC_EXT_TRIG_INJEC_BPWM3_TRGO               ((uint32_t)0x00013000)
#define ADC_EXT_TRIG_INJEC_NONE                     ((uint32_t)0x00007000)
#define IS_ADC_EXT_INJEC_TRIG(TRIG)                 (((TRIG) == ADC_EXT_TRIG_INJEC_T1_TRGO)            || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_T1_CC4)             || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_T3_TRGO)            || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_T3_CC1)             || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_T4_CC4)             || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_T5_TRGO)            || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_EXT_IT15_TIM2_CC4)  || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_BPWM0_TRGO)         || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_BPWM1_TRGO)         || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_BPWM2_TRGO)         || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_BPWM3_TRGO)         || \
                                                     ((TRIG) == ADC_EXT_TRIG_INJEC_NONE))
/**
  * @}
  */
...
#define ADC_INT_EC                                  ((uint16_t)0x0020)
#define ADC_INT_AWD                                 ((uint16_t)0x0040)
#define ADC_INT_JEC                                 ((uint16_t)0x0080)
