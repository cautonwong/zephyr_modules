...
#define USB_OTG_HS_BASE_ADDR                 USB_HS_BASE_S
#define USB_OTG_FS_BASE_ADDR                 USB_FS_BASE_S
#else
#define USB_OTG_HS_BASE_ADDR                 USB_HS_BASE
#define USB_OTG_FS_BASE_ADDR                 USB_FS_BASE
#endif
...
#define USB_OTG_PHY_OFFSET                   0xF000
