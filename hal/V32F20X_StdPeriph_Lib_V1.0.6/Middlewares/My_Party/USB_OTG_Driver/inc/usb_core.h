...
#define USB_OTG_FSDMPD                         (1 << 7)
#define USB_OTG_FSDMPU                         (1 << 6)
#define USB_OTG_FSDPPD                         (1 << 5)
#define USB_OTG_FSDPPU                         (1 << 4)

#define USB_HSPHY_XTALSEL_SHIFT      3
#define USB_HSPHY_XTALSEL_MASK       (7 << USB_HSPHY_XTALSEL_SHIFT)
#define USB_HSPHY_XTALSEL_10M        (0 << USB_HSPHY_XTALSEL_SHIFT)
#define USB_HSPHY_XTALSEL_12M        (1 << USB_HSPHY_XTALSEL_SHIFT)
#define USB_HSPHY_XTALSEL_25M        (2 << USB_HSPHY_XTALSEL_SHIFT)
#define USB_HSPHY_XTALSEL_30M        (3 << USB_HSPHY_XTALSEL_SHIFT)
#define USB_HSPHY_XTALSEL_19_2M      (4 << USB_HSPHY_XTALSEL_SHIFT)   
#define USB_HSPHY_XTALSEL_24M        (5 << USB_HSPHY_XTALSEL_SHIFT)

#define USB_HSPHY_PLLEN              (1 << 2)
#define USB_HSPHY_OSCOEN             (1 << 0)
