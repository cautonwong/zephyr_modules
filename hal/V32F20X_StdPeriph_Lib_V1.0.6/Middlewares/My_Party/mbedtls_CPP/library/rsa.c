...
#if 1 //TBD add test for bigger key
/*
...
#else
{
    ...
    unsigned char sha1sum[20];
#endif
#if defined(STD_PKHA_LONG_OPERANDS_ENABLE) \
    || (defined(STD_PKHA_INT_MAX_BYTES) && (STD_PKHA_INT_MAX_BYTES >= ((4096 / 8) * 2)))
    unsigned char rsa_ciphertext[4096 / 8];
    const char *rsa_keys[] = { RSA_PRIVATE_KEY_1024, RSA_PRIVATE_KEY_2048, RSA_PRIVATE_KEY_4096 };
#elif defined(STD_PKHA_INT_MAX_BYTES) && (STD_PKHA_INT_MAX_BYTES >= ((2048 / 8) * 2))
