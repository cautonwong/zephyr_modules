...
#if defined(MBEDTLS_STD_LTC_SHA256)
...
#elif defined(MBEDTLS_STD_LPC_SHA256)
...
#elif defined(MBEDTLS_STD_CAAM_SHA256)
...
#elif defined(MBEDTLS_STD_CAU3_SHA256)
...
#elif defined(MBEDTLS_STD_DCP_SHA256)
...
#elif defined(MBEDTLS_STD_HASHCRYPT_SHA256)
