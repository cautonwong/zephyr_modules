...
#if defined(MBEDTLS_STD_LTC_SHA1)
...
#elif defined(MBEDTLS_STD_LPC_SHA1)
...
#elif defined(MBEDTLS_STD_CAAM_SHA1)
...
#elif defined(MBEDTLS_STD_CAU3_SHA1)
...
#elif defined(MBEDTLS_STD_DCP_SHA1)
...
#elif defined(MBEDTLS_STD_HASHCRYPT_SHA1)
