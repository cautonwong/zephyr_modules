               ...
               USBH_Usr_cb_TypeDef *usr_cb)
{
  ...
  USB_OTG_WRITE_REG32(USB_OTG_FS_BASE_ADDR + USB_OTG_PHY_OFFSET, USB_OTG_FSDMPD|USB_OTG_FSDPPD);
#endif
#if defined (USE_USB_OTG_HS)  
  USB_OTG_WRITE_REG32(USB_OTG_HS_BASE_ADDR + USB_OTG_PHY_OFFSET, \
    USB_HSPHY_XTALSEL_12M|USB_HSPHY_PLLEN|USB_HSPHY_OSCOEN);
#endif
