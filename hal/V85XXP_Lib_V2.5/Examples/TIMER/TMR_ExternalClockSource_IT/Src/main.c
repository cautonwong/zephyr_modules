...
int main(void)
{
  ...
  /* Timer0 initialization:
       ...
       - Overflow interval: (4+1)/(external clock) */
  TMR_DeInit(TMR0);
  TMR_InitStruct.ClockSource = TMR_CLKSRC_EXTERNAL;
  TMR_InitStruct.EXTGT = TMR_EXTGT_DISABLE;
  TMR_InitStruct.Period = 5 - 1;
