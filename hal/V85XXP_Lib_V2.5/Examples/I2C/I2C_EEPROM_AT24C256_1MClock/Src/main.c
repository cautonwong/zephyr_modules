...
int main(void)
{
  ...
  /* Start the TMR3 Base generation with overflow frequency equal to 13107200Hz */
  TMR3_13M();  
    
  /* I2C initialization */
  I2C_DeInit(I2C_REMAP_DISABLE);
  I2C_StructInit(&I2C_InitStruct);
  I2C_InitStruct.ClockSource = I2C_CLOCKSOURCE_TIM3OFD8;
