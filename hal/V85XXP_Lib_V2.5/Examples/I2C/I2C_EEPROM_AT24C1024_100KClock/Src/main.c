...
uint8_t Wr_Buffer[BufferSize];
uint8_t Rd_Buffer[BufferSize];
...
int main(void)
{
  ...
  I2C_WRInitStruct.SubAddrType = I2C_SUBADDR_OTHER;
  I2C_WRInitStruct.SlaveAddr = 0xA0;
  I2C_WRInitStruct.PageRange = 256;
  I2C_WRInitStruct.Length = BufferSize;
  I2C_WRInitStruct.pBuffer = Wr_Buffer;
  I2C_WRInitStruct.SubAddress = 65500;
