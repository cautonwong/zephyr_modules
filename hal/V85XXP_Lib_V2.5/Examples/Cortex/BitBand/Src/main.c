...
#define OUT_IOB13 (BIT_BAND((uint32_t)&GPIOB->DAT, 13))
#define SET_IOB13 (BIT_BAND((uint32_t)&GPIOB->DAT, 13) = 1)
#define CLR_IOB13 (BIT_BAND((uint32_t)&GPIOB->DAT, 13) = 0)
...
int main(void)
{
  ...
  WDT_Disable();
  /* Toggle IOB13 with bit-band address */
  while (1)
  {
    SET_IOB13;    CLR_IOB13;
    SET_IOB13;    CLR_IOB13;
