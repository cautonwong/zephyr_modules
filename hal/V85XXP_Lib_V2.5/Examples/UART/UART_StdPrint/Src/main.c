...
int main(void)
{
  ...
  /* How to use printf() via UART.
     Compiler    Compiler-symbol    Description
     MDK_ARM     __CC_ARM           Selects [Use MicroLib], use fputc() to support
     EWARM       __ICCARM__         Selects [Full] in [Library configuration]->[Library], use fputc() to support
     Eclipse     __GNUC__           Selects [Do not use syscalls](--specs=nosys.specs), use _write() to support
     */
  printf("printf to UART OK!!!\r\n");
