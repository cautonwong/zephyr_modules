...
int i;
uint8_t Transmit_Buffer[4] = { 0x12, 0x34, 0x56, 0x78 };
...
int main(void)
{
  ...
  for (i=0; i<4; i++)
  {
    UART_SendData(UART0, Transmit_Buffer[i]);
    while (UART_GetFlag(UART0, UART_FLAG_TXDONE) == 0U);
