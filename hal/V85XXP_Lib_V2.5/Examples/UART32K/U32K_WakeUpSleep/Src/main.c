...
void Clock_Init(void)
{
  ...
  CLK_Struct.ClockType = CLK_TYPE_AHBSRC \
                        ...
                        |CLK_TYPE_HCLK   \
                        |CLK_TYPE_PCLK;
  CLK_Struct.AHBSource      = CLK_AHBSEL_6_5MRC;
...
int main(void)
{
  ...
  /* Wake-up when when receive data */
  U32K_WKUModeConfig(U32K0, U32K_WKUMOD_RX);
