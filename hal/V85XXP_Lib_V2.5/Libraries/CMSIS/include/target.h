...
typedef struct {                                /*!< (@ 0x40014200) ANA Structure                                              */
  ...
  __IM  uint32_t  ADCDCPN;                      /*!< (@ 0x000000CC) ANA_ADCDCPN.                                               */
  __IM  uint32_t  RESERVED4[2];
  __IM  uint32_t  ADCDCNM0;                     /*!< (@ 0x000000D8) ANA_ADCDCNM0.                                              */
...
typedef struct {                                /*!< (@ 0x40014800) RTC Structure                                              */
  ...
  __IOM uint32_t  ADCDTCTL;                     /*!< (@ 0x000000F0) RTC ADC data control                                       */
} RTC_Type;                                     /*!< Size = 244 (0xf4)                                                         */
...
#define ANA_REG6_VLCD_Pos                 (1UL)                     /*!< ANA REG6: VLCD (Bit 1)                                */
#define ANA_REG6_VLCD_Msk                 (0x1EUL)                  /*!< ANA REG6: VLCD (Bitfield-Mask: 0x0f)                  */
#define ANA_REG6_VLCD                     ANA_REG6_VLCD_Msk
...
/* =========================================================  REG7  ========================================================== */
#define ANA_REG7_VDCINHYSSEL_Pos          (2UL)                     /*!< ANA REG7: VDCINHYSSEL (Bit 2)                         */
#define ANA_REG7_VDCINHYSSEL_Msk          (0x4UL)                   /*!< ANA REG7: VDCINHYSSEL (Bitfield-Mask: 0x01)           */
#define ANA_REG7_VDCINHYSSEL              ANA_REG7_VDCINHYSSEL_Msk
/* =========================================================  REG8  ========================================================== */
...
#define ANA_ADCDOS_DOS_Msk                (0x1ffUL)                 /*!< ANA ADCDOS: DOS (Bitfield-Mask: 0x1ff)                */
#define ANA_ADCDOS_DOS                    ANA_ADCDOS_DOS_Msk
/* ========================================================  ADCDCPN  ======================================================== */
#define ANA_ADCDCPN_DCPN4_Pos             (27UL)                    /*!< ANA ADCDCPN: DCPN4 (Bit 27)                           */
#define ANA_ADCDCPN_DCPN4_Msk             (0xf8000000UL)            /*!< ANA ADCDCPN: DCPN4 (Bitfield-Mask: 0x1f)              */
#define ANA_ADCDCPN_DCPN4                 ANA_ADCDCPN_DCPN4_Msk
#define ANA_ADCDCPN_DCPN3_Pos             (18UL)                    /*!< ANA ADCDCPN: DCPN3 (Bit 18)                           */
#define ANA_ADCDCPN_DCPN3_Msk             (0x7fc0000UL)             /*!< ANA ADCDCPN: DCPN3 (Bitfield-Mask: 0x1ff)             */
#define ANA_ADCDCPN_DCPN3                 ANA_ADCDCPN_DCPN3_Msk
#define ANA_ADCDCPN_DCPN2_Pos             (9UL)                     /*!< ANA ADCDCPN: DCPN2 (Bit 9)                            */
#define ANA_ADCDCPN_DCPN2_Msk             (0x3fe00UL)               /*!< ANA ADCDCPN: DCPN2 (Bitfield-Mask: 0x1ff)             */
#define ANA_ADCDCPN_DCPN2                 ANA_ADCDCPN_DCPN2_Msk
#define ANA_ADCDCPN_DCPN1_Pos             (0UL)                     /*!< ANA ADCDCPN: DCPN1 (Bit 0)                            */
#define ANA_ADCDCPN_DCPN1_Msk             (0x1ffUL)                 /*!< ANA ADCDCPN: DCPN1 (Bitfield-Mask: 0x1ff)             */
#define ANA_ADCDCPN_DCPN1                 ANA_ADCDCPN_DCPN1_Msk
/* =======================================================  ADCDCNM0  ======================================================== */
#define ANA_ADCDCNM0_NM0_Pos              (0UL)                     /*!< ANA ADCDCNM0: NM0 (Bit 0)                             */
#define ANA_ADCDCNM0_NM0_Msk              (0x1ffUL)                 /*!< ANA ADCDCNM0: NM0 (Bitfield-Mask: 0x1ff)              */
#define ANA_ADCDCNM0_NM0                  ANA_ADCDCNM0_NM0_Msk
/* ======================================================  ADCDATADMA  ======================================================= */
...
#define ANA_ADCCTRL2_ADC_CAL_DONE_Msk     (0x80UL)                  /*!< ANA ADCCTRL2: ADC_CAL_DONE (Bitfield-Mask: 0x01)      */
#define ANA_ADCCTRL2_ADC_CAL_DONE         ANA_ADCCTRL2_ADC_CAL_DONE_Msk
...
/* =======================================================  ADCDTCTL  ======================================================== */
#define RTC_ADCDTCTL_ENDED_IN2ADC_CONVERT_Pos (30UL)                /*!< RTC ADCDTCTL: ENDED_IN2ADC_CONVERT (Bit 30)           */
#define RTC_ADCDTCTL_ENDED_IN2ADC_CONVERT_Msk (0xc0000000UL)        /*!< RTC ADCDTCTL: ENDED_IN2ADC_CONVERT (Bitfield-Mask: 0x03) */
#define RTC_ADCDTCTL_ENDED_IN2ADC_CONVERT     RTC_ADCDTCTL_ENDED_IN2ADC_CONVERT_Msk
