...
void FLASH_CycleInit(void)
{
  ...
  if (hclk > 1000000)
    MISC2->FLASHWC = (hclk/1000000)<<MISC2_FLASHWC_CYCLE_1US_Pos;
  else
    MISC2->FLASHWC = 0;
}
...
/**
  ...
  * @param  Addr: The address of flash to be erased. The entire sector corresponding to the address will be erased.
  * @retval None
  */
...
/**
  ...
  * @param  Addr: program start address
            WordBuffer: The pointer of WordBuffer to be programmed
            Length: The length of WordBuffer to be programmed
  * @retval None  
  */
...
/**
  ...
  * @param  Addr: program start address
            HWordBuffer: The pointer of HWordBuffer to be programmed
            Length: The length of HWordBuffer to be programmed
  * @retval None  
  */
...
/**
  ...
  * @param  Addr: program start address
            ByteBuffer: The pointer of ByteBuffer to be programmed
            Length: The length of ByteBuffer to be programmed
  * @retval None  
  */
...
/**
  ...
  * @param  NewState:
                ENABLE(ICE protection is successful when 0x7FC08 is 0x0A )
                DISABLE
  * @retval None.
  */
