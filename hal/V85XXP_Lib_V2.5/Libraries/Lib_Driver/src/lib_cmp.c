  ...
  if (CMPx == CMP_1)
  {
    ...
    switch(InitStruct->SignalSourceSel)
    {
      case CMP_SIGNALSRC_PPIN_TO_VREF:
        break;
      case CMP_SIGNALSRC_PPIN_TO_BGPREF: 
        ANA->REG2 |= ANA_REG2_CMP1REFSEL;
        break;
      case CMP_SIGNALSRC_PBAT_TO_VREF:   
        ANA->REGF |= ANA_REGF_BAT1DETEN;
        break;
      case CMP_SIGNALSRC_PBAT_TO_BGPREF: 
        ANA->REG2 |= ANA_REG2_CMP1REFSEL;
        ANA->REGF |= ANA_REGF_BAT1DETEN;
        break;
      case CMP_SIGNALSRC_NPIN_TO_VREF:   
        ANA->REG2 |= ANA_REG2_CMP1SEL_1;
        break;
      case CMP_SIGNALSRC_NPIN_TO_BGPREF: 
        ANA->REG2 |= (ANA_REG2_CMP1SEL_1|ANA_REG2_CMP1REFSEL);
        break;
      case CMP_SIGNALSRC_PPIN_TO_NPIN:   
        ANA->REG2 |= ANA_REG2_CMP1SEL_3;
        break;
      case CMP_SIGNALSRC_PBAT_TO_NPIN:   
        ANA->REG2 |= ANA_REG2_CMP1SEL_3;                                         
        ANA->REGF |= ANA_REGF_BAT1DETEN;
        break;
      default:
  ...
  else
  {
    ...
    switch(InitStruct->SignalSourceSel)
    {
      ...
      case CMP_SIGNALSRC_PBAT_TO_BGPREF: 
        ...
        break;
      case CMP_SIGNALSRC_NPIN_TO_VREF:   
        ANA->REG2 |= ANA_REG2_CMP2SEL_1;
        break;
      case CMP_SIGNALSRC_NPIN_TO_BGPREF: 
        ANA->REG2 |= (ANA_REG2_CMP2SEL_1|ANA_REG2_CMP2REFSEL);
        break;
      case CMP_SIGNALSRC_PPIN_TO_NPIN:   
        ANA->REG2 |= ANA_REG2_CMP2SEL_3;
        break;
      case CMP_SIGNALSRC_PBAT_TO_NPIN:   
        ANA->REG2 |= ANA_REG2_CMP2SEL_3;
        ANA->REGF |= ANA_REGF_BATRTCDETEN;
