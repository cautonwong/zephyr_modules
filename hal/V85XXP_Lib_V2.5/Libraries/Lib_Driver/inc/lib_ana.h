...
#define ANA_STATUS_CMP2         ANA_CMPOUT_CMP2
#define ANA_STATUS_CMP1         ANA_CMPOUT_CMP1
...
#define ANA_INT_CMP2           ANA_INTEN_INTEN3
#define ANA_INT_CMP1           ANA_INTEN_INTEN2
...
#define IS_ANA_STATUS(__STATUS__)  (((__STATUS__) == ANA_STATUS_AVCCLV)    ||\
                                    ...
                                    ((__STATUS__) == ANA_STATUS_CMP2)     ||\
                                    ((__STATUS__) == ANA_STATUS_CMP1)     ||\
...
#define IS_ANA_INTSTSR(__INTSTSR__)  (((__INTSTSR__) == ANA_INT_UPPER_TH3)     ||\
                                      ...
                                      ((__INTSTSR__) == ANA_INT_CMP2)         ||\
                                      ((__INTSTSR__) == ANA_INT_CMP1)         ||\
