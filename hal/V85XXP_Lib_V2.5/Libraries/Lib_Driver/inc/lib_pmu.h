...
typedef struct
{
  uint32_t CMP1Power;           /* Comparator 1 power control */
  uint32_t CMP2Power;           /* Comparator 2 power control */
...
/* CMP1Power */
#define PMU_CMP1PWR_ON         (ANA_REG3_CMP1PDN)
#define PMU_CMP1PWR_OFF        (0UL)
#define IS_PMU_COMP1PWR(__CMP1PWR__)  (((__CMP1PWR__) == PMU_CMP1PWR_ON) ||\
                                       ((__CMP1PWR__) == PMU_CMP1PWR_OFF))
/* CMP2Power */
#define PMU_CMP2PWR_ON         (ANA_REG3_CMP2PDN)
#define PMU_CMP2PWR_OFF        (0UL)
#define IS_PMU_COMP2PWR(__CMP2PWR__)  (((__CMP2PWR__) == PMU_CMP2PWR_ON) ||\
                                       ((__CMP2PWR__) == PMU_CMP2PWR_OFF))
/* TADCPower */
...
/* VDDDetector */
#define PMU_VDDDET_ALWAYSON     (0UL)
#define PMU_VDDDET_OFF          (1UL)
#define PMU_VDDDET_ON_RTCCLK    (2UL)
#define PMU_VDDDET_ON_7MS       (3UL)
#define IS_PMU_VDDDET(__VDDDET__)  (((__VDDDET__) == PMU_VDDDET_ALWAYSON)  ||\
                                    ((__VDDDET__) == PMU_VDDDET_OFF)       ||\
                                    ((__VDDDET__) == PMU_VDDDET_ON_RTCCLK) ||\
                                    ((__VDDDET__) == PMU_VDDDET_ON_7MS))
...
#define PMU_PWRSTS_AVCCLV         ANA_CMPOUT_AVCCLV
...
#define PMU_VDCINHYSSEL_100MV          (0x0UL << ANA_REG7_VDCINHYSSEL_Pos)
#define PMU_VDCINHYSSEL_200MV          (0x1UL << ANA_REG7_VDCINHYSSEL_Pos)
#define IS_PMU_VDCIN_HYSSEL(__HYSSEL__)  (((__HYSSEL__) == PMU_VDCINHYSSEL_100MV) ||\
