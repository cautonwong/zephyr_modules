...
typedef uint32_t (*ADC_GetTimeoutFlag_t)(void);
...
#define ADC_SKIP_8         (0x8UL << RTC_ADCMACTL_SKIP_SAMPLE_Pos)
#define ADC_SKIP_12        (0xCUL << RTC_ADCMACTL_SKIP_SAMPLE_Pos)
...
#define ADC_FLAG_CAL_DONE     (0x1U << ANA_ADCCTRL2_ADC_CAL_DONE_Pos)
